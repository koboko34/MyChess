...
void Piece::Init()
{
	float offsetPixels = 1920.f / 6.f;
	float pieceTextureOffsetU = (offsetPixels / 1920.f);
	float pieceTextureOffsetV;
	
	// for some reason pieceTeam is always = WHITE

	if (pieceTeam == PieceTeam::WHITE)
	{
		pieceTextureOffsetV = 0.5f;
	}
	else if (pieceTeam == PieceTeam::BLACK)
	{
		pieceTextureOffsetV = 0.f;
	}
	else
	{
		pieceTextureOffsetV = 0.25f;
	}
	...
	GLfloat pieceVertices[] = {
	 0.5f,  0.5f, 0.f,		pieceTextureOffsetU * (pieceType + 1),			0.5f,
	 0.5f, -0.5f, 0.f,		pieceTextureOffsetU * (pieceType + 1),			0.f,
	-0.5f, -0.5f, 0.f,		pieceTextureOffsetU * (pieceType),				0.f,
	-0.5f,  0.5f, 0.f,		pieceTextureOffsetU * (pieceType),				0.5f
	};
